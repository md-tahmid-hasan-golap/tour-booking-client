    ...
    <div className="bg-white shadow-md rounded-2xl overflow-hidden hover:shadow-lg transition duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          {showAction && (
            <div>
              <button className="flex items-center gap-2 bg-yellow-500 text-white px-3 py-2 rounded-lg hover:bg-yellow-600 transition text-sm">
                <FaEdit /> Edit
              </button>
              <button className="flex items-center gap-2 bg-green-600 text-white px-3 py-2 rounded-lg hover:bg-green-700 transition text-sm">
                <FaSyncAlt /> Update
              </button>
            </div>
          )}
